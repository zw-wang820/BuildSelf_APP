  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(AppStrings.newLifeRecord),
        actions: [
          TextButton(
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(hintText: AppStrings.titleOptional),
            ),
            const SizedBox(height: 16),
            TextField(
      ...
      child: Container(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              Icon(Icons.add_photo_alternate_outlined, size: 32, color: AppColors.textSecondaryDark),
