    ...
    return Scaffold(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: AppColors.life, blurRadius: 6)],
              ),
            ),
      ...
      floatingActionButton: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: AppColors.life.withOpacity(0.5),
              blurRadius: 16,
  ...
  Widget _buildFilterChip(String? type, String label) {
    ...
    return FilterChip(
      ...
      labelStyle: TextStyle(
        color: isSelected ? AppColors.life : AppColors.textSecondaryDark,
        fontSize: 13,
      ),
      side: BorderSide(
