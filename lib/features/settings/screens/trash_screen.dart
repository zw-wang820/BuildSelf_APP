          ...
          children: [
            Container(
              ...
              decoration: const BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: AppColors.error, blurRadius: 6)],
              ),
            ),
        ...
        actions: [
          if (_items.isNotEmpty)
            TextButton(
              ...
              child: const Text('清空', style: TextStyle(color: AppColors.error, letterSpacing: 1)),
            ),
        ],
      ),
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: AppColors.error.withOpacity(0.2), blurRadius: 18)],
              ),
            ...
            Text('删除的记录将保留 30 天后自动清理',
                style: TextStyle(fontSize: 12, color: AppColors.textSecondaryDark.withOpacity(0.6))),
          ],
        ),
      ),
    );
        ...
        child: Column(
          ...
          children: [
            ...
            if (item.subtitle.isNotEmpty) ...[
              ...
              Text(
                item.subtitle,
                style: const TextStyle(fontSize: 12, color: AppColors.textSecondaryDark, height: 1.5),
                maxLines: 2,
                overflow: TextOverflow.ellipsis,
              ),
            ],
