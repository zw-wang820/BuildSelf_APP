...
class _GoalDetailScreenState extends State<GoalDetailScreen> {
      ...
      builder: (ctx) {
        return StatefulBuilder(
          builder: (ctx, setDialogState) {
            return AlertDialog(
              title: const Text(AppStrings.updateProgress),
              content: Column(
  ...
  Widget build(BuildContext context) {
    if (_loading) {
      return Scaffold(
        appBar: AppBar(title: const Text(AppStrings.goalTitle)),
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text(AppStrings.goalTitle),
        actions: [
          if (isActive)
            IconButton(
          ...
          children: [
            ...
            if (isActive) ...[
              ...
              ElevatedButton(
                ...
                child: const Text(AppStrings.updateProgress),
              ),
            ],
            const SizedBox(height: 24),
            ...
            if (_logs.isEmpty)
              const AppCard(
                child: Text('暂无推进记录', style: TextStyle(color: AppColors.textSecondaryDark)),
              )
            else
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (log.note != null && log.note!.isNotEmpty)
                                Text(log.note!, style: TextStyle(fontSize: 12, color: AppColors.textSecondaryDark)),
                            ],
                          ),
                        ),
                        Text(
              ...
              children: [
                Row(
                  children: [
                    ...
                    const Text(AppStrings.rewardLabel, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
