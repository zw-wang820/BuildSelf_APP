...
class _WorkEditScreenState extends State<WorkEditScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        leading: TextButton(onPressed: () => Navigator.pop(context), child: const Text(AppStrings.cancel)),
        ...
        actions: [
          TextButton(
            ...
            child: _saving
                ...
                : const Text(AppStrings.save, style: TextStyle(fontWeight: FontWeight.w600)),
          ),
        ],
      ),
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          TextField(controller: _titleController, decoration: const InputDecoration(hintText: AppStrings.titleOptional)),
          const SizedBox(height: 16),
          TextField(
